...
//			booter.font = font;
//			booter.states = [[ "Boot ", Color.black, Color.rand ],
//						   [ "Quit ", Color.white, Color.rand ]];
//			
...
//			killer.states = [["K", Color.black, Color.rand]];
//			killer.font = font;
...
//		makeDefault.states = [["-> default", Color.black, Color.rand]];
//		makeDefault.action = {
...
//		recorder.font = font;
//		recorder.states = [
//			["prepare rec", Color.black, Color.rand],
//			["record >", Color.red, Color.rand],
...
//				.canFocus_(false)
//				.states_([
//					["M", Color.black, Color.rand],
//					["M", Color.white, Color.rand]
//					])
//				.action_({arg me;
